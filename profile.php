...
<body>
  ...
  <div class= "navbar">
    <ul>
      ...
      <li><a href="#"><b> BOOKING</b></a>
        <ul>
            <li><a href="<?php echo $book; ?>"><b>Reservation</b></a></li>
        </ul>
      </li>
      ...
      <li style="float: right; padding: 0px;"><a href="logout.php"><i class="fa fa-circle-o-notch"></i></a></li>
    </ul>
  </div>
